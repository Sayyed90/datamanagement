package com.example.librarymanagementsystem.usermodule.controller;

import ch.qos.logback.core.util.StringUtil;
import com.example.librarymanagementsystem.borrowmodule.exception.BorrowException;
import com.example.librarymanagementsystem.usermodule.dto.LoginResponsePayload;
...
import com.example.librarymanagementsystem.usermodule.service.UserRegistrationService;
...
public class UserController {
    ...
    public ResponseEntity<String> registerUser(@RequestBody UserRegistration registration) throws EmailFormatException, UserRegistrationException, BorrowException {
